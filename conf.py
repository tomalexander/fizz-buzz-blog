...
BLOG_AUTHOR = "Tom Alexander"  # (translatable)
BLOG_TITLE = "FizzBuzz"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://fizz.buzz/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://fizz.buzz/"
BLOG_EMAIL = "tom@fizz.buzz"
BLOG_DESCRIPTION = "I write code"  # (translatable)
...
DEPLOY_COMMANDS = {
    'default': [
        ...
        "nikola build",
        "rsync -rav --delete output/ paphus@paphus.com:~/fizz.buzz/",
    ]
}
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="/posts/finger.html">{author}</a> - A Mobile Web Engineer at         <a href="http://tripadvisor.com" rel="nofollow">TripAdvisor</a>         {license}'
...
# is in the manual.
COMMENT_SYSTEM_ID = "FizzBuzzBlog"
